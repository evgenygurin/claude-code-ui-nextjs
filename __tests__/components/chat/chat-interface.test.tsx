...
describe('ChatInterface', () => {
  beforeEach(() => {
    jest.useFakeTimers();
    jest.clearAllMocks();
    // Mock Math.random to return 0 for consistent timing
  ...
  it('should simulate AI response after delay', async () => {
    ...
    // Fast-forward time to simulate response (1500ms since Math.random returns 0)
    await act(async () => {
    ...
    expect(
      screen.getByText(/I understand you want to.*Test command/)
    ).toBeInTheDocument();
  });
